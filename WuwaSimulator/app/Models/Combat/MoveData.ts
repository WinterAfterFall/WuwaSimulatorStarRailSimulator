...
export interface MoveData {
    ...
    autoStartFrame?: number;         // frame ที่เปลี่ยนเป็น auto นับจากเริ่มท่า — ไม่ใส่ = ท่านี้ไม่มี auto transition (ส่งเป็น changeToAutoTime ให้ scheduleStartOnFieldAction เพื่อ schedule GlobalFreeEvent)
}
